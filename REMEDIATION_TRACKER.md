...
**Last updated:** 2026-08-04, commit `c52b5e2`.
...
- `cd server && npm test` → **287 pass / 0 fail / 1 skipped** (288 total). The 1 skip is infra-conditional (`RATE_LIMIT_TEST_DATABASE_URL` not set in this run) — verified separately against a real disposable Postgres DB with 0 skipped/0 failed
