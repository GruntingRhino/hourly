          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 px-5 py-4">
            ...
            <div className="flex items-start gap-3 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-sm font-semibold text-gray-900">Stay signed in across sessions?</p>
            ...
            <div className="flex items-center gap-2 flex-shrink-0 pl-0 sm:pl-2">
              <button
                ...
                className="rounded-lg border border-gray-200 bg-white px-3.5 py-2 text-xs font-medium text-gray-600 hover:bg-gray-50 hover:border-gray-300 transition-colors whitespace-nowrap"
              >
                This session only
              </button>
              <button
                onClick={() => choose("persistent")}
                className="rounded-lg bg-blue-600 px-3.5 py-2 text-xs font-semibold text-white hover:bg-blue-700 transition-colors whitespace-nowrap"
              >
                Keep me signed in
              </button>
            </div>
