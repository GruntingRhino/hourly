...
export default function SchoolBeneficiaries() {
  ...
  const [tab, setTab] = useState<"approved" | "search" | "create">("approved");
    ...
    <div>
      ...
      <div className="flex gap-4 border-b mb-6">
        {[
          ...
          ...(isAdmin ? [{ key: "search", label: "Add from Directory" }, { key: "create", label: "Create Custom" }] : []),
        ].map((t) => (
                ...
                <div key={b.id} className="bg-white border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      {b.description && <div className="text-xs text-gray-400 mt-1 max-w-xl">{b.description}</div>}
                    </div>
