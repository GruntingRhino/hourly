      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
          ...
          <button
            ...
            disabled={!googleUrl}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-200 rounded-lg font-medium hover:bg-gray-50 hover:border-gray-300 text-gray-800 disabled:opacity-50 transition-colors"
          >
